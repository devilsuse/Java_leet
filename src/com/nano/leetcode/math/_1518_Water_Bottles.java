package com.nano.leetcode.math;
...
public class _1518_Water_Bottles {
    ...
    public int numWaterBottles(int numBottles, int numExchange) {
        ...
        while(remainder>= numExchange){
            int newBottles = remainder/numExchange;
            total += newBottles;
            remainder = newBottles + remainder % numExchange;
        }
        return total;
    }
}
...
Keep doing the following until we have less numBottles than the numExchange:
